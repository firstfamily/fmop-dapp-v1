...
ApplicationWindow {
    ...
    header: ToolBar{
        ...
        property int landscapeExtra: Constants.isLandscape? 1 : 0
        ...
        RowLayout {
            ...
            ToolButton {
                enabled: Constants.backToolButtonVisible
                focusPolicy: Qt.NoFocus
                Image {
                    id: backImageImage
                    visible: Constants.backToolButtonVisible
                    anchors.centerIn: parent
                    source: "qrc:/images/"+Constants.iconOnPrimaryFolder+"/arrow_back.png"
                }
                onClicked: {
                    navPane.onePageBack()
                }
            ...
            Rectangle {
                ...
                width:  320
                height: 23
                color: Constants.creatorTheme.Welcome_BackgroundColorNormal
                radius: 6
            ...
            ToolButton {
                ...
                Image {
                    id: buttonImage
                    anchors.centerIn: parent
                    source: "qrc:/images/"+Constants.iconOnPrimaryFolder+"/more_vert.png"
                }
                onClicked: {
                    optionsMenu.open()
                }
                Menu {
                    id: optionsMenu
                    MenuItem {
                        text: Constants.isDarkTheme? qsTr("Light Theme") : qsTr("Dark Theme")
                        onTriggered: {
